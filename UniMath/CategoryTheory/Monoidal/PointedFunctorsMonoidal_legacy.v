...
Section PointedFunctors_as_monoidal_category.
  ...
  Proof.
    ...
    - use (mk_lax_monoidal_functor
               ...
               (nat_trans_id _)).
      + use make_nat_trans.
        * intro PF1PF2. apply identity.
        * intros PF1PF2 PF1PF2' αα'. rewrite id_left. rewrite id_right.
          apply (nat_trans_eq hs). intro c. cbn. unfold horcomp_data.
          apply nat_trans_ax.
