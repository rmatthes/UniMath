...
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.graphs.colimits.
Require Import UniMath.Induction.M.CategoryTheory_legacy.categories.HSET.Core.
Require Import UniMath.Induction.M.CategoryTheory_legacy.categories.HSET.Slice.
Require Import UniMath.Induction.M.CategoryTheory_legacy.categories.HSET.Limits.
Require Import UniMath.Induction.M.CategoryTheory_legacy.categories.HSET.Colimits.
Require Import UniMath.Induction.M.CategoryTheory_legacy.categories.HSET.Structures.
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.initial.
Require Import UniMath.Induction.M.CategoryTheory_legacy.FunctorAlgebras.
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.binproducts.
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.products.
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.bincoproducts.
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.coproducts.
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.terminal.
Require Import UniMath.Induction.M.CategoryTheory_legacy.limits.graphs.limits.
Require Import UniMath.Induction.M.CategoryTheory_legacy.PrecategoryBinProduct.
Require Import UniMath.Induction.M.CategoryTheory_legacy.ProductCategory.
Require Import UniMath.Induction.M.CategoryTheory_legacy.Adjunctions.Core.
Require Import UniMath.Induction.M.CategoryTheory_legacy.Adjunctions.Examples.
Require Import UniMath.Induction.M.CategoryTheory_legacy.exponentials.
Require Import UniMath.Induction.M.CategoryTheory_legacy.whiskering.
Require Import UniMath.Induction.M.CategoryTheory_legacy.RightKanExtension.
Require Import UniMath.Induction.M.CategoryTheory_legacy.slicecat.

Require Import UniMath.Induction.M.CategoryTheory_legacy.Chains.Chains.
