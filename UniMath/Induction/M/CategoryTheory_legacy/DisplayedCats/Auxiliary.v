...
Much of this material could probably be moved upstream to the [Induction.M.CategoryTheory_legacy] library and elsewhere
(some of it is already present there).

* Direct products of precategories should instead be imported from [Induction.M.CategoryTheory_legacy.PrecategoryBinProduct].
* The unit precategory should be imported from [Induction.M.CategoryTheory_legacy.categories.StandardCategories].
...
Require Import UniMath.Induction.M.CategoryTheory_legacy.categories.StandardCategories.
...
(* TODO: use versions from [Induction.M.CategoryTheory_legacy] instead. *)
