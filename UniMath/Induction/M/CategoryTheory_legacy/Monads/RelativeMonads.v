...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.map] *)
Definition r_lift (R : RelMonad_data) {c d : C} (f : c --> d) : R c --> R d
  := r_bind R (#J f · r_eta R _ ).

End RMonad_def.

(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.map_id] and
               [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.map_map] *)
...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.is_nat_trans_η] *)
...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.map_bind] *)
...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.bind_map] *)
...
(** analogue of [UniMath.Induction.M.CategoryTheory_legacy.functor_categories.functor_eq_eq_from_functor_ob_eq *)
...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.Kleisli_Mor_η] *)
...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.Kleisli_Mor_bind] *)
...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.is_nat_trans_kleisli_mor] *)
...
(** generalize [UniMath.Induction.M.CategoryTheory_legacy.Monads.KTriples.Kleisli_composition_laws] *)
...
(** The canonical relative adjunction between J and the Kleisli category of a J-relative monad
    ...
    This is the obvious generalization of the material in [UniMath.Induction.M.CategoryTheory_legacy.Monads.KleisliCategory].
